  ...
  <div class="container-fluid">
    ...
    <?php
        if(isset($_POST['usuario']) && isset($_POST['password'])) {
            ...
            $query = "select * from permisos where usuario='".$_POST['usuario']."' and password='".md5($_POST['password'])."'";
            ...
            if ($resultado = mysqli_query($conexion_db, $query)) {
                ...
                if($contar>0){
                    ...
                    echo "<strong>Datos incorrectos!</strong> Usuario y/o contraseña equivocada, intente de nuevo.</div>";

      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <body>
            <section >
                ...
                <h3>Consulta de Producto por Almacén</h3><br>
                <table>
                        <?php         
                            $num = $_POST['idAlmacen'];                   
                            include ("conectar.php");
                             $query = "select apv.IdProducto, apv.Producto, apv.Descripcion, apv.Medida, apv.Presentacion, apv.Precio, apv.Almacen, apv.Cantidad from almacen_producto_view apv 
                            join $tabla_3 a
                            on apv.almacen = a.nombreA
                            where a.idAlmacen = $num ";

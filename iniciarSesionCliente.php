    ...
    <div class="col-sm-8 text-left">
       <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Acceso Clientes</strong></h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                          <div class="form-top">
                            <div class="form-top-left">
                              <h3>Bienvenido !!</h3>
                                <p>Ingresa tu Id de cliente y contraseña para acceder:</p>
                            </div>
                      ...
                      <div class="header-info">
                          ...
                          <form method="POST" action="loginCliente.php" onsubmit="return validars()">
                            <div class="form-group">
                              <label><b>Id Cliente</b></label> 
                              <input class="form-control" type="text" placeholder="Ingresa tu Id de cliente" id="idCliente" name="idCliente" required>
                              
                            </div>
                            <div class="form-group">
                              <td><label>Contraseña:</label></td>
                              <input class="form-control" type="password" placeholder="Ingresa tu contraseña" id="password" name="password" required>
                            </div>
                            <div class="checkbox">

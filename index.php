...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <section>
        <div>
          <div class="image" class="col-md-4" align="left">
            <a href="https://www.soludrip.com/"><img style="padding:15px 0px 15px 0px; float: left; margin: 5px 20px" class="img-responsive" src="images/soludrip.png"></a> 
          </div>
         </div>
        <div>
          <div class="image" class="col-md-4" align="right">
            <a href="concepto.html"><img style="padding:15px 0px 15px 0px; float: right; margin: 5px 20px" class="img-responsive" src="images/justintime1.png"></a> 
          </div>
         </div>
            <pre class="uno"><h1>¡¡Nutrición TOTAL!!</h1></pre><br>
        </div>
  </section>
